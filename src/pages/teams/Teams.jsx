  ...
  let step = [
    {
      ...
      text: "Stanislav says he is a real authentic gipsy as he is always “on his way”. In winter you can find him skiing in the mountains, in summer - driving across Europe, where he is currently involved in a number of collaborative creative projects for TELEPORTOUR network strengthening and business growth. ",
      body: "An expert in the implementation and scaling of innovation technologies and building relationships with decision-makers, Stanislav has more than 20 years of work experience in International Business Development, running startups, imagining, creating, and reimagining the ways of synergetic combinations of current solutions and disruptive technologies in the fields of Oil&Gas, Aerospace, and Wild Nature protection. His career as an entrepreneur has ups and downs, but his basic spiritual principle is always the same: move on and don’t give up. His first business was founded in the 1990s and it was a local travel magazine with an edition of fifteen thousand copies in which local travel companies and agencies published their paid advertising. Stanislav says: “It seems strange and at the same time fantastic to me that after so many years of “business adventure” I’m back to the travel topic but this time with a revolutionary product, which makes me feel incredibly happy!”. Thanks to his good communication and leadership skills, he managed to involve the right people in his project from the very beginning. At present, the TELEPORTOUR team consists of  experienced video content creators and producers, software engineers, well-known market research consultants, famous inventors and professionals in cross-cultural communication.",
    },
    {
